                                    ...
                                    <div class="input-group input-group-sm" style="width: 300px;">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <button type="button" class="btn btn-block btn-primary" data-toggle="modal"
                                                data-target="#addbModal" id="modal">Thêm
                                                    admin mới</button>
                                        </div>
                                </form>
                            </div>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover text-nowrap table-striped">
                            ...
                            <tbody>
                                ...
                                if (empty($tbS)) {
                                    $truyvan = "SELECT * FROM admin";
                                } else {
                                    $truyvan = "SELECT * FROM admin WHERE name like '%$tbS%'";
                                }
                                ...
                                if (empty($tbS)) {
                                    $truyvan = "SELECT * FROM admin LIMIT $batdau, $soluong";
                                } else {
                                    $truyvan = "SELECT * FROM admin WHERE name like '%$tbS%' LIMIT $batdau, $soluong";
                                }
                                $ketqua = mysqli_query($con, $truyvan) or die(mysqli_error($con));
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="QTV_XoaU.php" method="post"
                                                onsubmit="return confirm('Bạn có muốn tiếp tục xoá admin này?');">
                        ...
                        <ul class="pagination pagination-sm m-0 float-right">
                            ...
                            if ($tranghientai > 1 && $tongsotrang > 1) {
                                ...
                                <li class="page-item"><a class="page-link bg-primary"
                                        href="QTVadmin.php?trang=<?= $tranghientai - 1; ?>">&laquo;</a></li>
                                <?php
                            }
                            for ($i = 1; $i <= $tongsotrang; $i++) {
                                if ($i == $tranghientai) {
                                    ...
                                    echo '<li class="page-item"><a class="page-link bg-primary" href = "QTVadmin.php?trang=' . $i . '">' . $i . '</a></li>';

                                }
                            }
                            if ($tranghientai < $tongsotrang && $tongsotrang > 1) {

                                echo '<li class="page-item"><a class="page-link bg-primary" href="QTVadmin.php?trang=' . ($tranghientai + 1) . '">&raquo;</a></li>';
                            }
                            ?>
