...
<?php if(strlen($_SESSION['login']))
    {   ?>
				...
				<?php } ?>
					...
					<li><a href="my-wishlist.php"><i class="icon fa fa-heart"></i>Mục yêu thích</a></li>
...
<div class="cnt-block">
				<ul class="list-unstyled list-inline">
					<li class="dropdown dropdown-small">
						<a href="track-orders.php" class="dropdown-toggle" ><span class="key">Theo dõi orders</b></a>
