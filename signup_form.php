...
if (isset($_POST['sbtDangKy'])) {
    ...
    if (mysqli_num_rows(mysqli_query($con, "SELECT phone FROM khach_hang WHERE phone = '$phone'")) > 0) {
        ...
        $query = mysqli_query($con, "insert into khach_hang(name,email,phone,address,password,created) 
        values('$name','$email','$phone','$addr','$password','$date')");
        if ($query) {
                                ...
                                <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                    <div class="card-body p-4 p-lg-5 text-black">
                                        ...
                                        <form method="post" action="signup_form.php">
                                            ...
                                            <div class="form-outline mb-4">
                                                <input type="number" id="form2Example17" class="form-control form-control-lg" name="addr" value="<?= $addr; ?>" />
